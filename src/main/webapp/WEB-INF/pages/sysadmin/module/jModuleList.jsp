...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		<td><input type="checkbox" name="moduleId" value="${o.id}"/></td>
		...
		<td>${o.remark}</td>
		<td>
			<c:if test="${o.state==1}"><a href="stop?id=${o.id}">启用</a></c:if>
			<c:if test="${o.state==0}"><a href="start?id=${o.id}"><font color="red">停用</font></a></c:if>
		</td>
	</tr>
	</c:forEach>
